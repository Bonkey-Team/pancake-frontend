...
import { Heading, Text, Flex, ChevronRightIcon } from 'plkit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Bonkey Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Bonkey Collectibles are special ERC-721 NFTs that can be used on the BonkeySwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Bonkey Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved Bonkey Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
